  ...
  return (
    <Card className="relative bg-card ring-white/8">
      ...
      <CardContent className="flex flex-col gap-3 py-1">
        ...
        <button type="button" onClick={() => setOpen((v) => !v)} aria-expanded={open} className="inline-flex w-fit items-center gap-1 text-[11px] font-medium text-muted-foreground hover:text-foreground">
